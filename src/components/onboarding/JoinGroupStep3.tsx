...
export function JoinGroupStep3({
  onBack,
  onJoinGroup,
}: {
  onBack: () => void;
  onJoinGroup: (depth: number) => void;
}) {
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-['Inter:Regular',sans-serif] font-normal text-[16px] text-[rgb(190,89,42)] tracking-[-0.3125px]">
            ...
            {/* Description Box */}
            <div className="bg-[rgba(233,155,99,0.1)] rounded-[12px] p-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={onBack}
                className="flex-1 h-[36px] bg-[#fbf9f8] rounded-[10px] border border-[#e99b63] font-['Inter:Medium',sans-serif] font-medium text-[14px] text-[rgb(190,89,42)] leading-[20px] tracking-[-0.1504px] hover:opacity-90 transition-opacity"
              >
                Back
              </button>
              <button
                onClick={handleJoinGroup}
                className="flex-1 h-[36px] bg-[rgb(190,89,42)] rounded-[10px] font-['Inter:Medium',sans-serif] font-medium text-[14px] text-white leading-[20px] tracking-[-0.1504px] hover:opacity-90 transition-opacity"
              >
                Join Group
              </button>
            </div>
