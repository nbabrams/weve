import svgPaths from "./svg-y0aogu3et7";

function Heading1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#264859] text-[16px] text-nowrap top-0 tracking-[-0.3125px] whitespace-pre">Invite Code</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#67717e] text-[16px] text-nowrap top-0 tracking-[-0.3125px] whitespace-pre">Enter the code shared by your friend</p>
    </div>
  );
}
    ...
    <div className="bg-[#f6f7f9] h-[36px] relative rounded-[10px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[36px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#67717e] text-[16px] text-nowrap tracking-[1.2875px] uppercase whitespace-pre">XXXXXXXX</p>
        </div>
      </div>
...
function MainContent() {
  return (
    <div className="bg-white h-[216px] relative rounded-[16px] shadow-[0px_2px_8px_0px_rgba(38,72,89,0.08)] shrink-0 w-[358px]" data-name="Main Content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] h-[216px] items-start pb-0 pt-[24px] px-[24px] relative w-[358px]">
        <Container />
        <Button />
      </div>
    </div>
...
export default function Component140JoinGroup() {
  return (
    <div className="bg-[#fbf9f8] relative size-full" data-name="1.40 - Join Group">
      <JoinGroup />
      <JoinGroup1 />
    </div>
  );
