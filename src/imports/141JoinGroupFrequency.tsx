import svgPaths from "./svg-e090421irt";

function Heading1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#264859] text-[16px] text-nowrap top-0 tracking-[-0.3125px] whitespace-pre">Your Preferences</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-white h-[84px] left-[107.33px] rounded-[12px] top-0 w-[95.328px]" data-name="Button">
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[17.67px] not-italic text-[#264859] text-[16px] top-[18px] tracking-[-0.3125px] w-[66px]">2-3 Days</p>
    </div>
  );
}
...
export default function Component141JoinGroupFrequency() {
  return (
    <div className="bg-[#fbf9f8] relative size-full" data-name="1.41 - Join Group > Frequency">
      <JoinGroup />
      <JoinGroup1 />
    </div>
  );
