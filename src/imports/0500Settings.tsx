import svgPaths from "./svg-3m1fpq9jka";
...
function Heading() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[30px] left-0 not-italic text-[#264859] text-[20px] text-nowrap top-0 tracking-[-0.4492px] whitespace-pre">Settings</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#67717e] text-[14px] text-nowrap top-0 tracking-[-0.1504px] whitespace-pre">Manage your profile and preferences</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[86px] relative shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] h-[86px] items-start pb-0 pt-[16px] px-[16px] relative w-full">
          <Heading />
          <Paragraph />
        </div>
      </div>
...
function Header() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col h-[87px] items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Header">
