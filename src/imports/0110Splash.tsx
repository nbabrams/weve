  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[32px] py-0 relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#67717e] text-[14px] text-center tracking-[-0.1504px] w-[192px]">— Percy Bysshe Shelley</p>
        </div>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[128px] items-start relative shrink-0 w-full">
      <Paragraph />
      <Paragraph1 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[112px] items-center justify-center relative shrink-0">
...
function Container() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[16px] items-start pb-[24px] pt-[32px] px-0 relative shrink-0 w-[257.297px]" data-name="Container">
      <Frame />
